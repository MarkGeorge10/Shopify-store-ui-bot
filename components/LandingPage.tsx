...
export default function LandingPage({
    ...
    return (
        <div className="min-h-screen text-black overflow-hidden relative" style={{ background: 'var(--gradient-hero)' }}>
            {/* Animated background blobs */}
            <div className="absolute inset-0 pointer-events-none overflow-hidden">
                <div className="animate-blob absolute -top-32 -right-32 w-[600px] h-[600px] rounded-full opacity-20"
                    style={{ background: 'radial-gradient(circle, #059669, #065f46, transparent 70%)' }} />
                <div className="animate-blob absolute top-1/2 -left-48 w-[500px] h-[500px] rounded-full opacity-15"
                    style={{ background: 'radial-gradient(circle, #10b981, #065f46, transparent 70%)', animationDelay: '3s' }} />
                <div className="animate-blob absolute bottom-0 right-1/4 w-[450px] h-[450px] rounded-full opacity-10"
                    style={{ background: 'radial-gradient(circle, #065f46, #0369a1, transparent 70%)', animationDelay: '5s' }} />
                {/* Grid overlay */}
                <div className="absolute inset-0 opacity-5"
                    style={{ backgroundImage: 'linear-gradient(rgba(6,95,70,0.1) 1px, transparent 1px), linear-gradient(90deg, rgba(6,95,70,0.1) 1px, transparent 1px)', backgroundSize: '60px 60px' }} />
            </div>
            ...
            <nav className="relative z-10 flex items-center justify-between px-8 py-6 max-w-7xl mx-auto">
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-2xl flex items-center justify-center shadow-lg"
                        style={{ background: 'var(--gradient-1)', boxShadow: '0 4px 20px rgba(6,94,70,0.5)' }}>
                        <Sparkles className="w-5 h-5 text-white" />
                    </div>
                    <div>
                        <span className="text-lg font-bold tracking-tight text-black">AI Concierge</span>
                ...
                <div className="flex items-center gap-2">
                    <button
                        ...
                        className="px-5 py-2.5 text-sm font-semibold text-black/70 hover:text-black transition-colors rounded-xl hover:bg-emerald-50"
                    >
                        Log In
                    </button>
                    <button
            ...
            <main className="relative z-10 max-w-7xl mx-auto px-8 pt-16 pb-36">
                ...
                >
                    ...
                    <div className="flex items-center justify-center gap-4 flex-wrap">
                        ...
                        <button
                            onClick={() => { switchTab('login'); openAuthModal(); }}
                            className="glass px-8 py-4 text-base rounded-2xl font-bold hover:bg-emerald-50 transition-all text-emerald-950 bg-white/90 shadow-sm border-emerald-100"
                        >
                            Sign In
                        </button>
                    </div>
                    ...
                    >
                        {[
                            ...
                            <div key={stat.label} className="text-center">
                                ...
                                <div className="text-xs font-medium mt-1" style={{ color: 'rgba(0,0,0,0.5)' }}>{stat.label}</div>
                            </div>
                        ))}
                    </motion.div>
                </motion.div>
                    ...
                    {[
                        {
                            ...
                            gradient: 'from-emerald-800/20 via-emerald-100/10 to-transparent',
                            iconGradient: 'linear-gradient(135deg, #065f46, #064e3b)',
                        ...
                        },
                        {
                            ...
                            gradient: 'from-teal-800/20 via-emerald-800/10 to-transparent',
                            iconGradient: 'linear-gradient(135deg, #0f766e, #065f46)',
                        ...
                        },
                        {
                            ...
                            gradient: 'from-green-800/20 via-emerald-800/10 to-transparent',
                            iconGradient: 'linear-gradient(135deg, #166534, #064e3b)',
                        ...
                        >
                            ...
                            <p className="text-sm leading-relaxed" style={{ color: 'rgba(0,0,0,0.6)' }}>{feature.description}</p>
                        </motion.div>
                    ))}
                </motion.div>
            </main>
